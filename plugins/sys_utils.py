...
♨️ **⚡вσℓт ꪜꫀ᥅ᦓ꠸ꪮꪀ    ⚡ :** Ver 0.0.1
♨️ **⚡υρ ѕιη¢є       ⚡ :** __{get_readable_time((time.time() - start_time))}__
♨️ **⚡ID             ⚡ :** 2
♨️ **⚡DRIVE VIEW     ⚡ :** __{disk}_ 
♨️ **⚡𝙿𝚐𝚛𝚊𝚖 νєяѕιση  ⚡:** 1.0.3
♨️ **⚡𝙿𝚈𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 ⚡ :** 3.1
♨️ **⚡𝙾𝙿𝙴𝚁𝙰𝚃𝙸𝙽𝙶 𝚂𝚈𝚂𝚃𝙴𝙼⚡ :** Ubuntu
"""
